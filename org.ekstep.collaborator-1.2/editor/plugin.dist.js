...
org.ekstep.pluginframework.pluginManager.registerPlugin({"id":"org.ekstep.collaborator","ver":"1.2","author":"Vivek Kasture","title":"Collaborator plugin","description":"","publishedDate":"","editor":{"main":"editor/plugin.js","dependencies":[{"type":"css","src":"editor/collaborator.css"},{"type":"js","src":"editor/libs/initial.min.js"},{"type":"js","src":"editor/libs/angular-inview.js"}]}},org.ekstep.contenteditor.basePlugin.extend({currentInstance:void 0,initialize:function(){var e=this;ecEditor.addEventListener("org.ekstep.collaborator:add",this.loadBrowser,this);var t=ecEditor.resolvePluginResource(e.manifest.id,e.manifest.ver,"editor/collaborator.html"),o=ecEditor.resolvePluginResource(e.manifest.id,e.manifest.ver,"editor/collaboratorApp.js");ecEditor.getService("popup").loadNgModules(t,o)},loadBrowser:function(e,t){currentInstance=this,currentInstance.startLoadTime=new Date,ecEditor.getService("popup").open({template:"partials/collaborator",controller:"collaboratorCtrl",controllerAs:"$ctrl",resolve:{instance:function(){return currentInstance}},width:851,showClose:!1,closeByDocument:!1,closeByEscape:!0,className:"ngdialog-theme-plain"},function(){})}}))