...
declare -a coreplugins=("org.ekstep.activitybrowser-1.3"
                ...
                "org.ekstep.questionunit.survey-1.0"
                "org.ekstep.questionunit.feedback-1.0"
